...
namespace kenzauros.RHarbor.Models
{
    ...
    internal class PortForwarding : BindableBase
    {
        ...
        public int? LocalPort { get { return _LocalPort; } set { SetProp(ref _LocalPort, value); } }
        private int? _LocalPort;

        [PropertyOrder(4), DisplayName("Remote Host")]
        public string RemoteHost { get { return _RemoteHost; } set { SetProp(ref _RemoteHost, value); } }
